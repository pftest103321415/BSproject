...
public class AllInOneBase {
	...
	public AllInOneBase(){
		try{
			...
			String configPath = "./src/main/resources/payment_conf.xml";
			//configPath之值如右 /C:/__ecpay(servlet)/_workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/ecpay/WEB-INF/classes/payment_conf.xml
