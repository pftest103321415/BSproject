...
<head>
    ...
    <!-- 購物車表格與css與js功能 -->
    <link rel="stylesheet" href="/static/assets/css/buycarOrderProductList.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="/static/assets/js/buycarproductlist.js"></script>
