...
<body>
        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <!-- <i class="bi bi-cart-fill"></i> bootstrap 購物車圖案 -->
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="http://localhost:8080/buycarOrderProduct">點數商城</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="http://localhost:8080/buycarOrderquerymainaction.controller">購物車</a>
  </li>
</ul>
